...
def doseResponsePlot(ax, modelDF):
    ...
    for cell in modelDF.Cell.unique():
        for animal in modelDF.loc[modelDF.Cell == cell].Animal.unique():
            ...
            """
            ax[index].set(title="Dose Response Curve for " + animal + " " + cell)
